...
type TestimonialItemType = Pick<WebsiteSettings['mainPage']['featuredReviews'][number], 'rating' | 'content' | 'author'> & {
    role: string;
}

export function TestimonialsSection(props: { testimonials: TestimonialItemType[] }) {
    ...
    const testimonials =  useMemo(() => {
        ...
        return props.testimonials.map((t, index) => {
            const connectItem = defaultData[index]
            return {
                ...t,
                rotation: connectItem ? connectItem.rotation : "",
            }
        }).slice(0, 5)
    }, [props.testimonials])
    return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="flex items-center mt-auto">
                                        ...
                                        <div>
                                            <div className="font-bold text-foreground text-sm">{testimonial.author.name}</div>
