...
export default function LessonView() {
    ...
    const prevLesson = lesson?.meta?.prevLesson ? 
      course?.attachedLessons?.find(l => l.lessonId === lesson.meta.prevLesson) : null;
    
    const nextLesson = lesson?.meta?.nextLesson ? 
      course?.attachedLessons?.find(l => l.lessonId === lesson.meta.nextLesson) : null;
      ...
      return (
        <div className="min-h-screen bg-background">
          ...
          <div className="container mx-auto px-4 py-20 text-center">
            ...
            <p className="text-muted-foreground mb-4">{error?.message || "The requested lesson could not be found."}</p>
