...
import { Clock, Search } from "@workspace/icons";
...
export default function CoursesPage() {
    ...
    const loadCoursesQuery = trpc.lmsModule.product.publicList.useQuery({
        ...
        filter: {
            filterBy: (selectedType && selectedType !== "all" ? [selectedType] : undefined) as any,
        },
    }, {
        staleTime: 0,
    });
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
                            Choose from our comprehensive collection of programming and data science courses designed to take you
                    ...
                    <div className="flex flex-col gap-6 min-h-[80vh]">
                        <div className="flex flex-col sm:flex-row justify-between gap-4">
                            ...
                            <Select value={selectedType} onValueChange={setSelectedType}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value={Constants.CourseType.COURSE}>Course</SelectItem>
                                    <SelectItem value={Constants.CourseType.DOWNLOAD}>Download</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        ...
                        {(!loading && totalPages && courses.length === 0) ? (
                            <div className="flex flex-col gap-4 items-center justify-center py-12 text-center">
                                ...
                                <Subheader1 theme={theme.theme}>This page is empty.</Subheader1>
                                <Button size="sm" theme={theme.theme} onClick={() => handlePageChange(1)}>
                                    Go to first page
                                </Button>
                            </div>
                        ) : (
                            <div className="space-y-8">
                                {loading ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        {
                                            courses.map((course) => (
                                                <CourseCard key={course.courseId} course={course as any}  />
                                            ))
                                        }
                                    </div>
                                )}
