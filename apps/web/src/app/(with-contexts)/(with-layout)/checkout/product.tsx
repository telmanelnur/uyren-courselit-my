...
export default function ProductCheckout() {
    ...
    const loadCourseQuery = trpc.lmsModule.courseModule.course.publicGetByCourseId.useQuery({
        courseId: entityId!,
    }, {
    ...
    const loadCommunityQuery = trpc.communityModule.community.getByCommunityId.useQuery({
        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Unable to load checkout</h3>
                    <p className="text-gray-600 mb-4">
                        {loadCourseQuery.error?.message || loadCommunityQuery.error?.message || "An error occurred while loading the checkout details."}
                    </p>
                    <button 
        ...
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                <div className="text-center">
                    ...
                    <p className="text-gray-600">Please select a course or community to checkout.</p>
                </div>
            </div>
            );
    }
