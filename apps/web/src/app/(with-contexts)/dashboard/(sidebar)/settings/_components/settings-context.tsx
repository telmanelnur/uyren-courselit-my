...
type SettingsType = GeneralRouterOutputs["siteModule"]["siteInfo"]["getSiteInfo"]["settings"]

interface SettingsContextType {
  settings: SettingsType | null
  loadSettingsQuery: ReturnType<typeof trpc.siteModule.siteInfo.getSiteInfo.useQuery>
  updateSettingsMutation: ReturnType<typeof trpc.siteModule.siteInfo.updateSiteInfo.useMutation>
}
