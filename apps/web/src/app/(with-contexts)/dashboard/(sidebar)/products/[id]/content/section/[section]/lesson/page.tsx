...
export default function LessonPage() {
    ...
    const { data: lesson, isLoading: lessonLoading } = trpc.lmsModule.courseModule.lesson.getById.useQuery({
        lessonId: lessonId!,
    }, {
        enabled: !!lessonId,
    });
            ...
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        {isEditing ? "Edit lesson details" : "Create a new lesson for this section"}
                    </p>
                </div>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Enter video URL (YouTube, Vimeo, etc.)" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
                        ...
                        <div className="flex items-center justify-end gap-4">
                            ...
                            <Button type="submit" disabled={form.formState.isSubmitting}>
                                {form.formState.isSubmitting ? "Saving..." : (isEditing ? "Update Lesson" : "Create Lesson")}
                            </Button>
                        </div>
                    </form>
                </Form>
