...
type ItemType = GeneralRouterOutputs["lmsModule"]["courseModule"]["course"]["getMembers"][number];
type QueryParams  = Parameters<typeof trpc.lmsModule.courseModule.course.getMembers.useQuery>[0];
...
export default function ProductCustomersPage() {
    ...
    const { data: product, isLoading: productLoading } = trpc.lmsModule.courseModule.course.getByCourseDetailed.useQuery({
        courseId: productId,
    });
    ...
    const loadListQuery = trpc.lmsModule.courseModule.course.getMembers.useQuery(queryParams);
    useEffect(() => {
                            ...
                            <Dialog open={customerDialogOpen} onOpenChange={setCustomerDialogOpen}>
                                ...
                                <DialogContent>
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Invite a new customer to this product by entering their email address and optional tags.
                                        </DialogDescription>
                                    </DialogHeader>
                                    <form onSubmit={handleCustomerSubmit} className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <ComboBox
                                                ...
                                                onChange={(values: string[]) => setCustomerFormData(prev => ({ ...prev, tags: values }))}
                                            />
                                        </div>
                                        <DialogFooter>
                                            <Button
                                            ...
                                            <Button
                                                type="submit"
                                                disabled={savingCustomer || !customerFormData.email.trim()}
                                            >
