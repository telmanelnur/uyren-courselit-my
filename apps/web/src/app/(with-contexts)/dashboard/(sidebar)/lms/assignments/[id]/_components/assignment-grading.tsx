                ...
                <CardContent>
                    <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <div className="flex items-center gap-3 p-4 border rounded-lg">
                            ...
                            <div>
                                <div className="text-2xl font-bold">{assignment?.totalPoints || 0}</div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-4 border rounded-lg">
                            ...
                            >
                                ...
                                {assignment?.rubric && assignment.rubric.length > 0 ? "Edit" : "Create"} Rubric
                            </Button>
                        </div>
                        ...
                        <div className="flex items-center justify-between p-4 border rounded-lg">
                            ...
                            <Badge variant={assignment?.peerReviewEnabled ? "default" : "secondary"}>
