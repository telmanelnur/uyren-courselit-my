...
type ThemeType = GeneralRouterOutputs["lmsModule"]["themeModule"]["theme"]["getById"];

interface ThemeContextType {
    initialData: ITheme;
    theme: ThemeType | null;
    mode: FormMode;
    loadDetailQuery: ReturnType<typeof trpc.lmsModule.themeModule.theme.getById.useQuery>;
    updateMutation: ReturnType<typeof trpc.lmsModule.themeModule.theme.update.useMutation>;
}
