        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              The subdomain you're looking for doesn't exist or is not configured properly.
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-lg p-6 mb-8">
            ...
            <div className="space-y-3 text-left">
              <div className="flex items-start gap-3">
                ...
                <p className="text-muted-foreground">Check the URL for any typos</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-brand-primary rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-muted-foreground">Contact the site administrator if you believe this is an error</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-brand-primary rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-muted-foreground">Try accessing the main domain instead</p>
              </div>
            </div>
          </div>
