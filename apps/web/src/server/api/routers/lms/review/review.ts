...
export const reviewRouter = router({
    ...
    update: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            const review = await getReviewOrThrow(undefined, ctx as any, input.data.reviewId);
            ...
            Log.info("Review updated", { reviewId: input.data.reviewId, userId: ctx.user.userId });
    ...
    delete: protectedProcedure
        ...
        .mutation(async ({ ctx, input }) => {
            const review = await getReviewOrThrow(undefined, ctx as any, input.reviewId);
            ...
            Log.info("Review deleted", { reviewId: input.reviewId, userId: ctx.user.userId });
            return { success: true };
        }),
    ...
    publicGetByReviewId: publicProcedure
        ...
        .query(async ({ ctx, input }) => {
            ...
            return {
                ...
                featuredImage: review.featuredImage ? formatMedia(review.featuredImage) : null,
                tags: review.tags,
