...
export const activityRouter = router({
    ...
    getMyActivities: protectedProcedure
        .input(z.object({
            type: z.enum(Object.values(Constants.ActivityType) as [string, ...string[]]).optional(),
    ...
    getActivityStats: protectedProcedure
        .input(z.object({
            duration: z.enum(["1d", "7d", "30d", "90d", "1y", "lifetime"]).default("30d"),
        }))
        .query(async ({ ctx, input }) => {
            ...
            startDate.setDate(startDate.getDate() - (duration === "1d" ? 0 : duration === "7d" ? 6 : duration === "30d" ? 29 : duration === "90d" ? 89 : 365));
