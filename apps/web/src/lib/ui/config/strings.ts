...
export const USER_FILTER_CATEGORY_COMMUNITY = "Community";
...
export const USER_FILTER_COMMUNITY_HAS = "Member of";
export const USER_FILTER_COMMUNITY_DOES_NOT_HAVE = "Not a member of";
...
export const USER_FILTER_PRODUCT_DROPDOWN_LABEL = "Select product";
export const USER_FILTER_COMMUNITY_DROPDOWN_LABEL = "Select community";
...
export const PERM_MANAGE_COMMUNITY = "Manage community";
...
export const USER_TABLE_HEADER_COMMUNITIES = "Communities";
