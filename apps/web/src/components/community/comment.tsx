import { DELETED_COMMENT_PLACEHOLDER } from "@/lib/ui/config/strings";
import {
  formattedLocaleDate,
...
interface CommentProps {
  ...
  onReply: (commentId: string, content: string, parentReplyId?: string) => void;
              ...
              onClick={() => {
                if (replyContent.trim()) {
                  isCommunityComment(comment)
                    ...
                    : onReply(comment.commentId, replyContent, comment.replyId);
                  setReplyContent("");
                  setIsReplying(false);
                }
              }}
