...
import { Image, Paperclip, Smile, Video } from "lucide-react";
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" className="w-full !text-left cursor-text">
          Write something...
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[90vw] md:max-w-[600px] w-full overflow-y-auto max-h-[calc(100vh-4rem)] my-8">
        ...
        {media.length > 0 && (
          <div className="mt-4 overflow-x-auto">
            <MediaPreview items={media} onRemove={handleMediaRemove} />
          </div>
        )}
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
          <div className="flex flex-wrap items-center gap-2">
            <Popover modal={true}>
              ...
              <PopoverContent className="w-80">
                <div className="grid gap-4">
                  <h4 className="font-medium leading-none">Attach files</h4>
                  <Input
                    id="file"
                    type="file"
                    multiple
            ...
            <Popover modal={true}>
              ...
              <PopoverContent className="w-80">
                <div className="grid gap-4">
                  <h4 className="font-medium leading-none">Add video</h4>
                  <Input
                    id="video"
                    type="url"
