...
import { ArrowLeft, ArrowRight, ArrowDownward } from "@workspace/icons";
import { isEnrolled } from "@/lib/ui/lib/utils";
    ...
    <div className="h-full">
      <article className="flex flex-col pb-[100px] lg:max-w-[40rem] xl:max-w-[48rem] mx-auto">
        ...
        {lesson && !error && (
          <>
            <header>
              <h1 className="text-4xl font-semibold mb-4">{lesson.title}</h1>
            </header>
            ...
            {String.prototype.toUpperCase.call(LESSON_TYPE_EMBED) ===
              lesson.type &&
              lesson.content && <LessonEmbedViewer content={lesson.content} />}
