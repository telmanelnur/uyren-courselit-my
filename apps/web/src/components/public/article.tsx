...
import { Course, Profile, SiteInfo } from "@workspace/common-models";
import { BLOG_UPDATED_PREFIX, UNNAMED_USER } from "@/lib/ui/config/strings";
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="font-light text-sm text-muted-foreground">
                <span className="font-medium">{BLOG_UPDATED_PREFIX}:</span>{" "}
