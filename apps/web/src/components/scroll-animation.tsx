...
import { motion, useInView, cubicBezier, type TargetAndTransition } from "framer-motion"
import { cn } from "@/lib/utils"
type AnimationVariant = "fadeIn" | "fadeUp" | "fadeDown" | "fadeLeft" | "fadeRight" | "scale" | "flip" | "rotate"
...
}: ScrollAnimationProps & { staggerDelay?: number; childDelay?: number; staggerChildren?: boolean }) {
  const ref = useRef(null)
  const isInView = useInView(ref, {
    once,
    amount: "some",
