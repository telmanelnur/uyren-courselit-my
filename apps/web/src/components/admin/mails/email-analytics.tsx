...
import { Sequence } from "@workspace/common-models";
...
export default function EmailAnalytics({ sequence }: EmailAnalyticsProps) {
  ...
  const loadAnalytics = async () => {
    ...
    try {
      ...
      if (response) {
        const { totalEmailsSent, openRate, clickThroughRate } = response;
        ...
        <div className="max-w-md mx-auto">
          <div className="mb-4">
            ...
            <p className="text-muted-foreground text-sm">
              Analytics will be available once the {sequence.type.toLowerCase()}{" "}
              is sent to a few subscribers.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Total number of people subscribed to this sequence</p>
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Total number of emails delivered to subscribers</p>
                  </TooltipContent>
                </Tooltip>
              </div>
              <div className="text-2xl font-bold">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Percentage of recipients who opened the email</p>
                  </TooltipContent>
                </Tooltip>
              </div>
              <div className="text-2xl font-bold">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 mb-1">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Percentage of email openers who clicked a link</p>
                  </TooltipContent>
                </Tooltip>
              </div>
              <div className="text-2xl font-bold">
