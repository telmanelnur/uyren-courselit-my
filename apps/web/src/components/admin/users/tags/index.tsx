...
import { MoreVert } from "@workspace/icons";import { GeneralRouterOutputs } from "@/server/api/types";

type TagWithDetailType = GeneralRouterOutputs["userModule"]["tag"]["withDetails"][number];
