...
import { Add, MoreVert } from "@workspace/icons";
import { Lesson, Address, Group } from "@workspace/common-models";
import {
  Section,
  Link,
  LessonIcon,
        ...
        <div className="flex justify-between items-center">
          ...
          <Menu2 icon={<MoreVert />} variant="soft">
            ...
            <MenuItem
              ...
              onClick={() => onGroupDelete(group.id, course.courseId)}
            />
          </Menu2>
        </div>
        <div>
          <DragAndDrop
            items={course.lessons
              ...
              .sort(
                (a: any, b: any) =>
                  (group.lessonsOrder as any[])?.indexOf(a.lessonId) -
                  (group.lessonsOrder as any[])?.indexOf(b.lessonId),
              )
              .map((lesson: Lesson) => ({
                id: lesson.lessonId,
                courseId: course.courseId,
