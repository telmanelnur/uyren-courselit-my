...
// Email configuration
const testEmail = process.env.TEST_EMAIL || process.env.SUPER_ADMIN_EMAIL || "test@example.com";
const fromEmail = process.env.MAIL_FROM || `${process.env.SUPER_ADMIN_NAME || "CourseKit"} <noreply@coursekit.com>`;
...
async function sendTestEmail() {
    try {
        ...
        const templateData = {
            ...
            features: ["Pug Templates", "Zod Validation", "Queue Processing", "Nodemailer"]
        };
