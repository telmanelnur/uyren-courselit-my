...
// --- Hooks ---
import { useMenuNavigation } from "@workspace/text-editor/tiptap/hooks/use-menu-navigation";
import { useTiptapEditor } from "@workspace/text-editor/tiptap/hooks/use-tiptap-editor";

// --- Icons ---
import { ChevronDownIcon } from "@workspace/text-editor/tiptap/components/tiptap-icons/chevron-down-icon";
...
// --- Utils ---
import { chunkArray } from "@workspace/text-editor/tiptap/lib/tiptap-advanced-utils";

// --- Styles ---
import "@workspace/text-editor/tiptap/components/tiptap-ui/color-text-popover/color-text-popover.scss";
