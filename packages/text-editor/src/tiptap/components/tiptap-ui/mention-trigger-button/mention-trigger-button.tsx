...
// --- Tiptap UI ---
import type { UseMentionTriggerConfig } from "@workspace/text-editor/tiptap/components/tiptap-ui/mention-trigger-button";
import {
  MENTION_TRIGGER_SHORTCUT_KEY,
  useMentionTrigger,
} from "@workspace/text-editor/tiptap/components/tiptap-ui/mention-trigger-button";
