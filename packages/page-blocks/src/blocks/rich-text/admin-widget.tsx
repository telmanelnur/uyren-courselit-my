...
import { Address, HorizontalAlignment } from "@workspace/common-models";
import { fontSize as defaultFontSize } from "./defaults";
import { CssIdField } from "@workspace/components-library";
    ...
    <div className="flex flex-col gap-4 mb-4">
      ...
      <AdminWidgetPanel title="Design">
        <Select
          ...
          onChange={(value: HorizontalAlignment) => setAlignment(value)}
        />
        <PageBuilderSlider
          title="Font size"
          min={1}
