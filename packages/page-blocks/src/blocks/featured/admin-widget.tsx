...
import type { Theme, ThemeStyle } from "@workspace/page-models";
...
import { Delete } from "@workspace/icons";
import { Alignment, Address } from "@workspace/common-models";
  ...
  return (
    <div className="flex flex-col gap-4 mb-4">
      ...
      {productsLoaded && (
        <AdminWidgetPanel title="Products">
          <Select
            ...
            value={""}
            options={allProducts
              .filter((product) => !products.includes(product.courseId))
              .map((product) => ({
                label: product.title,
          ...
          <ul className="flex flex-col gap-4">
            {products.map((product: string) => {
              ...
              return (
                <li className="flex justify-between" key={productItem.courseId}>
      ...
      <AdminWidgetPanel title="Design">
        ...
        />
        <VerticalPaddingSelector
          value={verticalPadding || theme.theme.structure.section.padding.y}
