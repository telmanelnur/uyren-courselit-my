      ...
      >
        ...
        <div
          className={`w-full ${
            ...
            hasHeroGraphic && alignment === "right" ? "md:pr-1" : "md:pr-0"
          } ${hasHeroGraphic && alignment === "left" ? "md:pl-1" : "md:pl-0"}`}
        >
          <div
            className={clsx(
          ...
          >
            ...
            >
              {buttonAction && buttonCaption && (
                <Link href={buttonAction} theme={overiddenTheme}>
                  <Button
                    theme={overiddenTheme}
              ...
              {secondaryButtonAction && secondaryButtonCaption && (
                <Link href={secondaryButtonAction} theme={overiddenTheme}>
                  <Button
                    theme={overiddenTheme}
                    className="w-full md:min-w-[150px]"
                    variant="secondary"
