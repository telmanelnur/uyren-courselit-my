...
import type { Address, Media, Profile } from "@workspace/common-models";
        ...
        {isVideo(youtubeLink, media) ? (
          <div className="flex flex-col gap-2">
            <div className="flex justify-between mt-2">
              ...
              <Checkbox
                ...
                onChange={(value: boolean) => setPlayVideoInModal(value)}
              />
            </div>
            <Select
              title="Aspect ratio"
          ...
          <div>
            <Select
              ...
              onChange={(value: ImageObjectFit) => setObjectFit(value)}
            />
          </div>
        )}
      </AdminWidgetPanel>
