...
import { Address, Alignment } from "@workspace/common-models";
import {
  AdminWidgetPanel,
  Select,
  TextEditor,
...
import { PageBuilderSlider } from "@workspace/components-library";
        ...
        <Form className="flex flex-col gap-4">
          ...
          <div className="flex justify-between">
            ...
            <Checkbox
              ...
              onChange={(value: boolean) => setPricingSwitcher(value)}
            />
          </div>
          {pricingSwitcher && (
            <>
