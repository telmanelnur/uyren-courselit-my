...
import { Edit, Help } from "@workspace/icons";
...
import { Checkbox } from "@workspace/components-library";
...
export default function LinkEditor({
  ...
  const [isPrimary, setIsPrimary] = useState<boolean>(link.isPrimary || false);
      ...
      {editing && (
        <Form className="flex flex-col gap-2 mb-4">
          ...
          <div className="flex gap-2 justify-end">
            <Button component="button" onClick={deleteLink} variant="soft">
              Delete
            </Button>
