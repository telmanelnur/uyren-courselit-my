...
import { DragAndDrop } from "@workspace/components-library";
...
export default function AdminWidget({
  ...
  const [showLoginControl, setShowLoginControl] = useState<boolean | undefined>(
    ...
    <div className="flex flex-col gap-4 mb-4">
      ...
      <AdminWidgetPanel title="Design">
        <Select
          ...
          onChange={(value: "font-light" | "font-normal" | "font-bold") =>
      ...
      <AdminWidgetPanel title="Other settings">
        <div className="flex justify-between">
          ...
          <Checkbox
            ...
            onChange={(value: boolean) => setShowLoginControl(value)}
          />
        </div>
      </AdminWidgetPanel>
    </div>
