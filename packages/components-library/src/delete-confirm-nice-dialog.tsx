...
export const DeleteConfirmNiceDialog = NiceModal.create<DeleteConfirmDialogProps<any>,
    { reason: 'cancel'; data: null } | { reason: 'confirm'; data: any }
>(({ title = "Delete Item", message = "Are you sure you want to delete this item? This action cannot be undone.", data }) => {
