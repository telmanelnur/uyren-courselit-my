...
export function hide(modal: string | React.ComponentType<any>): Promise<unknown> {
    const modalId = getModalId(modal);
...
export function useModal<C, P extends Partial<NiceModalArgs<React.ComponentType<C>>>>(
    modal: React.ComponentType<C>,
    args?: P
): Omit<NiceModalHandler, "show"> & {
    show: <T = C extends { __niceReturn?: (args: never) => infer R } ? R : unknown>(args?: P) => Promise<T>;
};

export function useModal(
    modal?: string | React.ComponentType<any>, 
    args?: Record<string, unknown>
): NiceModalHandler | (Omit<NiceModalHandler, "show"> & {
...
export const create = <
    P extends NiceModalHocProps,
    TReturn = unknown
>(
    Comp: React.ComponentType<P>
): (React.ComponentType<P & NiceModalHocProps> & { __niceReturn?: (args: never) => TReturn }) => {
...
export const ModalHolder = <T extends Record<string, unknown> = Record<string, unknown>>({
    modal,
    handler,
    ...restProps
}: {
