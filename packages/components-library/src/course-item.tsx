...
import type { Course, SiteInfo } from "@workspace/common-models";
  ...
  return (
    <Link href={href}>
      <article className="flex flex-col">
        <div className="mb-4 border rounded-md overflow-hidden">
          <Image
            src={
              ...
              (course.featuredImage.file || course.featuredImage.thumbnail)
            }
        ...
        {course.type !== Constants.CourseType.BLOG && (
          <h3 className="font-thin text-xs">{course.type.toUpperCase()}</h3>
        )}
